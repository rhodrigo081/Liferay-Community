...
  const matchesDateFilter = (eventDate: string, filterType: string): boolean => {
...
        <AgendaExportButton onClick={() => setIsModalOpen(true)}>Criar evento</AgendaExportButton>
...
                <AgendaDateSeparator>{formatDisplayDate(event.date)}</AgendaDateSeparator>
